...
public class WarehouseInventory extends SinglyListDictionary<String,InventoryRecord> {
	...
	public double query(String attribute, double perct)
	{
	...
	public BinarySearchTree createTreeIndex(String attribute)
	{
		...
		case "unitprice":
			...
			{
				BST.insert(this.vList.getValue().getUnitPrice());
				this.vList.next();
			}
			break;
	...
	void command(WarehouseInventory a)
	{
		...
		{	
			...
			case 8:
				System.out.println("Please type the attributes for the item ");
				util.depthFirstTraverse(createTreeIndex(scanner_in.next()).getRootNode());
				util.showPath();
				break;
			case 9:
				System.out.println("Please type the attributes for the item ");
