...
public class DoubleList<T> implements List<T> {
	...
	public void insert(T item) {
		...
		//set next node and new node point to current
			current.setNextNode(new DoubleNode<T>(item,current,current.next()));
			//move current to current node
	...
	public void append(T item) {
		// TODO Auto-generated method stub
			...
			{
				//append to tail and reset current to next_current
